declare namespace Cheat_Menu {
  ...
  interface KeyListeners {
    [key: string]: (event?: MouseEvent | KeyboardEvent) => void; // Key can be number or string
    [key: number]: (event?: MouseEvent | KeyboardEvent) => void;
  }
  ...
  let menu_update_timer: number | null; // NodeJS.Timeout or number for browser setInterval ID
  ...
  // DOM Elements
  const overlay_box: HTMLDivElement;
  const overlay: HTMLTableElement;
  const style_css: HTMLLinkElement;

  // Menu building functions
  const menus: Array<() => void>;
  ...
  function god_mode(actor: Game_Actor): void;
  function god_mode_off(actor: Game_Actor): void;
  ...
  function give_exp(actor: Game_Actor, amount: number): void;
  function give_stat(actor: Game_Actor, stat_index: number, amount: number): void;
  ...
  function append_actor_selection(key1: string | number, key2: string | number): void;
  ...
  function append_enemy_cheats(key1: string | number, key2: string | number, key3: string | number, key4: string | number): void;
  ...
  function append_hp_cheats(key1: string | number, key2: string | number, key3: string | number, key4: string | number, key5: string | number, key6: string | number): void;

  function party_mp_cheat_1(): void;
  // ... (similar for other party_mp_cheat_N and append_mp_cheats)
  function append_mp_cheats(key1: string | number, key2: string | number, key3: string | number, key4: string | number, key5: string | number, key6: string | number): void;


  function party_tp_cheat_1(): void;
  // ... (similar for other party_tp_cheat_N and append_tp_cheats)
  function append_tp_cheats(key1: string | number, key2: string | number, key3: string | number, key4: string | number, key5: string | number, key6: string | number): void;
  ...
  function append_amount_selection(key1: string | number, key2: string | number): void;

  function scroll_move_amount(direction: "left" | "right", event?: MouseEvent): void;
  function append_move_amount_selection(key1: string | number, key2: string | number): void;

  function apply_current_exp(direction: "left" | "right", event?: MouseEvent): void;
  ...
  function apply_current_stat(direction: "left" | "right", event?: MouseEvent): void;
  function append_stat_selection(key1: string | number, key2: string | number, key3: string | number, key4: string | number): void;

  function apply_current_gold(direction: "left" | "right", event?: MouseEvent): void;
  function append_gold_status(key1: string | number, key2: string | number): void;

  function apply_speed_change(direction: "left" | "right", event?: MouseEvent): void;
  function apply_speed_lock_toggle(): void;
  function append_speed_status(key1: string | number, key2: string | number, key3: string | number): void;

  function scroll_item(direction: "left" | "right", event?: MouseEvent): void;
  function apply_current_item(direction: "left" | "right", event?: MouseEvent): void;
  function append_item_selection(key1: string | number, key2: string | number, key3: string | number, key4: string | number): void;

  function scroll_weapon(direction: "left" | "right", event?: MouseEvent): void;
  function apply_current_weapon(direction: "left" | "right", event?: MouseEvent): void;
  function append_weapon_selection(key1: string | number, key2: string | number, key3: string | number, key4: string | number): void;

  function scroll_armor(direction: "left" | "right", event?: MouseEvent): void;
  function apply_current_armor(direction: "left" | "right", event?: MouseEvent): void;
  function append_armor_selection(key1: string | number, key2: string | number, key3: string | number, key4: string | number): void;
  ...
  function scroll_variable(direction: "left" | "right", event?: MouseEvent): void;
  function apply_current_variable(direction: "left" | "right", event?: MouseEvent): void;
  function append_variable_selection(key1: string | number, key2: string | number, key3: string | number, key4: string | number): void;

  function scroll_switch(direction: "left" | "right", event?: MouseEvent): void;
  function toggle_current_switch(event?: MouseEvent): void;
  function append_switch_selection(key1: string | number, key2: string | number, key3: string | number): void;

  function save_position(pos_num: number, event?: MouseEvent): void;
  function recall_position(pos_num: number, event?: MouseEvent): void;
  function append_save_recall(key1: string | number, key2: string | number, key3: string | number, key4: string | number, key5: string | number, key6: string | number): void;

  function scroll_map_teleport_selection(direction: "left" | "right", event?: MouseEvent): void;
  function scroll_x_teleport_selection(direction: "left" | "right", event?: MouseEvent): void;
  function scroll_y_teleport_selection(direction: "left" | "right", event?: MouseEvent): void;
  function teleport_current_location(event?: MouseEvent): void;
  function append_teleport(key1: string | number, key2: string | number, key3: string | number, key4: string | number, key5: string | number, key6: string | number, key7: string | number): void;
